...
public record RaceEarlyRegistrationOpenDateScheduled(Guid RaceId, int EarlyRegistrationId, DateTime RegistrationOpenDate, Guid PilotPolicyId, long PolicyVersion);
