...
public class NaeRacesQueryDbContext : DbContext
{
    ...
    public DbSet<PilotPolicyStatement> PilotPolicyStatements => Set<PilotPolicyStatement>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PilotRaceRegistration>()
            .HasKey(prr => new { prr.PilotId, prr.RaceId });
    }
}
