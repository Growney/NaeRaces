...
public record ClubMembershipLevel(Guid ClubId, int MembershipLevelId, string Name, Guid? RacePolicyId, long? PolicyVersion, IEnumerable<ClubMembershipLevelPaymentOption> PaymentOptions);
