...
public record PilotSelectionPolicyInsuranceProviderRequirementStatement(Guid ClubId, string InsuranceProvider, string ValidationPolicy) : IPilotSelectionPolicyStatement
{
